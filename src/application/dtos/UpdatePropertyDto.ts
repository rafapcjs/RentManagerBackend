...
export class UpdatePropertyDto {
  ...
  validate(): string[] {
    ...
    if (this.estado !== undefined) {
      if (!Object.values(PropertyStatus).includes(this.estado)) {
  ...
  toDomain() {
    ...
    if (this.direccion !== undefined) result.direccion = this.direccion;
    if (this.tipo !== undefined) result.tipo = this.tipo;
    if (this.valor_arriendo !== undefined) result.valor_arriendo = this.valor_arriendo;
    if (this.estado !== undefined) result.estado = this.estado;
    if (this.descripcion !== undefined) result.descripcion = this.descripcion;
    if (this.codigo_agua !== undefined) result.codigo_agua = this.codigo_agua;
    if (this.codigo_luz !== undefined) result.codigo_luz = this.codigo_luz;
    if (this.codigo_gas !== undefined) result.codigo_gas = this.codigo_gas;
