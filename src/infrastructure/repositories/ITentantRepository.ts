import { AppDataSource } from '../../config/data-sour  async getByDni(dni: string): Promise<Tenant | null> {
  ...
  async update(dni: string, data: Partial<Tenant>): Promise<Tenant | null> {
